  ...
  onload(function () {
    setTimeout(function () { //为了更加准确，所以加3s延时
      ...
      tracker.send({
        ...
        firstContentfulPaint:FCP.startTime, //首个dom元素的绘制
        firstMeaningfulPaint:FMP.startTime, //首次有意义的内容绘制
        largestContentfulPaint:LCP.startTime, //最大的内容绘制
      })
